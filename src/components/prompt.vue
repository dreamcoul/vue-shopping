        ...
        <div class="clear module-dialog module-dialog-confirm module-dialog-show" style="display: block; opacity: 1;">
            <div class="dialog-panel">
                <div class="topbar">
                    ...
                    <span class="dialog-close png" @click="cancelPrompts"></span>
                </div>
                <div class="dialog-con js-dialog-container">
                    <div class="confirm-msg">商品已达到最大可购买数量，无法继续添加</div>
                </div>
                <div class="dialog-btn-wrap clear" @click="cancelPrompts">
...
<script>
    export default {
        ...
        methods: {
            cancelPrompts() {
                // let cancels = true
                // this.$emit('cancel', cancels)
                this.$store.commit('cancelPrompt')
                // console.log(cancels)
            }
        },
        computed:{
            IsMax(){
                  return this.$store.state.isMaxNum
            }
        }
    }
</script>
